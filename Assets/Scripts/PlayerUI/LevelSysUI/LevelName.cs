...
public class LevelName : MonoBehaviour
{
    ...
    public string CanhGioi(int currentLevel)
    {
        var ranges = new List<(int min, int max, List<Action> action)>
        {
            ...
            {
                () => {TuVi = "Trúc Cơ"; ExpBonus = 200;atkBonus = 30;
                    defBonus = 30; }
            }),
           (21, 30, new List<Action>
            {
                () => {TuVi = "Kim Đan"; ExpBonus = 300; atkBonus = 100;
                    defBonus = 100;}
            }),
            (31, 40, new List<Action>
            {
                () => {TuVi = "Nguyên Anh"; ExpBonus = 400;atkBonus = 1000;
                    defBonus = 1000; }
            }),
            (41, 50, new List<Action>
            {
                () => {TuVi = "Hoá Thần"; ExpBonus = 500; atkBonus = 5000;
                    defBonus = 5000;}
            }),
            (51, 60, new List<Action>
            {
                () => {TuVi = "Phản Hư"; ExpBonus = 600; atkBonus = 10000;
                    defBonus = 10000;}
            }),
            (61, 70, new List<Action>
            {
                () => {TuVi = "Hợp Thể"; ExpBonus = 700; atkBonus = 70000;
                    defBonus = 70000;}
            }),
            (71, 80, new List<Action>
            {
                () => {TuVi = "Độ Kiếp"; ExpBonus = 800;atkBonus = 100000;
                    defBonus = 100000; }
            }),
            (81, 90, new List<Action>
            {
                () => {TuVi = "Đại Thừa"; ExpBonus = 900; atkBonus = 1000000;
                    defBonus = 1000000;}
            }),
            (91, 100, new List<Action>
            {
                () => {TuVi = "Chân Tiên"; ExpBonus = 1000; atkBonus = 999999999;
                    defBonus = 999999999;}
            }),
        };
